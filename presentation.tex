...
\begin{frame}[t]{The Data}
	...
	\itm \textbf{Expectation:} Near the origin of replication = Higher Expression
	\ei
...
\begin{frame}{Summary}
	...
	\ch In \strep, genes under positive selection ($\omega$ $>$ 1) were near the terminus and most likely part of the accessory genome
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
