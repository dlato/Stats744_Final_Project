...
\begin{frame}{Spatial Molecular Trends}
	\begin{columns}[t]
		\column{.5\textwidth}
		\centering
		\includegraphics[width=0.67\textwidth]{C:/Users/Daniella/Documents/Sinorhizobium2015/LabMeetingPresentations/Spatial_genome_trends_graphs/mut_graph.pdf}\\
		\includegraphics[width=0.67\textwidth]{C:/Users/Daniella/Documents/Sinorhizobium2015/LabMeetingPresentations/Spatial_genome_trends_graphs/exp_graph.pdf}
		\column{.5\textwidth}
		\centering
...
\begin{frame}[t]{The Data}
	\begin{columns}[t]
		...
		\begin{column}{0.5\textwidth}
			...
			\bi
			\itm \ecol, \bass, \strep, and \smel
			\itm dN (change in amino acid), dS (no change in amino acid), and $\omega$ (ratio) + distance from the origin of replication
			\bi
			\itm $\omega$ $>$ 1 (positive selection), $\omega$ = 1 (neutral), $\omega$ $<$ 1 (negative selection)
			\itm \textbf{Expectation:} Most genes are under neutral or negative selection, genes that are under positive selection should be accessory genes
			\bi
