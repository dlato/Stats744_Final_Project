...
, as we move away from the origin, we barely see any significant changes in the expression values. Until we are around 35 (50Kbp) away from the origin, that is when expresion values starts to decrease. Which is expected, as that is where we expect most of our accessory genomes to be located.
