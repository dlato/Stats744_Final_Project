...
We also wanted to pick colours that were subjectively pretty, but also dichromat-friendly.
...
We chose to use the facet_wrap() function in R to allow for overarching similarities or differences between the bacterial replicons to be visible.
