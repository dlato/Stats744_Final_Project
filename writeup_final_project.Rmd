...
For this graphic we also had many itterations (see *Appendix* Figure A3).
...
I did not go with facets, because the range of values of the distance from the origin of replication differs for each bacteria. 
