...
In Daniella's thesis, she fit models and analyzed how gene expression changes with distance from the origin of replication for all of the bacterial replicons.
To avoid repetition, we decided to graph the gene expression of only the \strep
genome versus the distance from the origin of replication and to be consistent with the selection analysis. 
